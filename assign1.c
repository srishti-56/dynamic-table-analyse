...
void main(){
	...
	fp_max_insert = fopen("op42/Max_Insert.txt", "a");
	fp_max_delete = fopen("op42/Max_Delete.txt", "a");
	fp_avg_all = fopen("op42/Avg_All.txt", "a");
	fp_avg_insert = fopen("op42/Avg_Insert.txt", "a");
	fp_avg_delete = fopen("op42/Avg_Delete.txt", "a");
	...
	for(k=0; k<5; k++){
		...
		fprintf(fp_max_insert, "\t %lf", increase_arr[k]);
		fprintf(fp_max_delete, "\t %lf", increase_arr[k]);
		fprintf(fp_avg_all, "\t %lf", increase_arr[k]);
		fprintf(fp_avg_insert, "\t %lf", increase_arr[k]);
		fprintf(fp_avg_delete, "\t %lf", increase_arr[k]);
	}
